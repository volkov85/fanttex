...
(function () {
  function initProductPage() {
    ...
    if (product) {
      ...
      let productGallerySwiper = new Swiper(`.product__gallery-inner`, {
        slidesPerView: 1,
        on: {
          init(swiper) {
      ...
      if (selectionColor) {
        ...
        dropdownInit(selectionColor, true, selectionColorSearchInput);
       ...
       */
      dropdownInit(productAmount, true, productAmountInput);
